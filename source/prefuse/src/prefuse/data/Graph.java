...
public class Graph extends CompositeTupleSet {
     ...
     */
    public Iterator<Node> inNeighbors(Node n) {
     ...
     */
    public Iterator<Edge> outNeighbors(Node n) {
     ...
     */
    public Iterator<Edge> edges(Node node) {
        nodeCheck(node, true);
     ...
     */
    public Iterator<Edge> inEdges(Node node) {
        nodeCheck(node, true);
     ...
     * node
     */
    public Iterator<Edge> outEdges(Node node) {
        nodeCheck(node, true);
